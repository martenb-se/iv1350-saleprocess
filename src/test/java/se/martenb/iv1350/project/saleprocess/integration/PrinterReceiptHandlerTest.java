...
public class PrinterReceiptHandlerTest {
    ...
    public void testCreateReceiptString() {
        ...
        PrinterReceiptHandler receiptHandler = 
                new PrinterReceiptHandler(receiptDTO);
        ...
        String result = receiptHandler.createReceiptString();
        
        assertTrue(result.equals(expectedOutput.toString()), 
                "Wrong receipt string created.");
    }
